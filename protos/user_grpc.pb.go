...
const (
	UserService_GetUsersInfo_FullMethodName = "/UserService/getUsersInfo"
)
...
type UserServiceClient interface {
	GetUsersInfo(ctx context.Context, in *User, opts ...grpc.CallOption) (*User, error)
}
...
func (c *userServiceClient) GetUsersInfo(ctx context.Context, in *User, opts ...grpc.CallOption) (*User, error) {
	out := new(User)
...
func (UnimplementedUserServiceServer) GetUsersInfo(context.Context, *User) (*User, error) {
...
func _UserService_GetUsersInfo_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServiceServer).GetUsersInfo(ctx, req.(*User))
	}
